...
import net.mcreator.ccalumod.item.WaterGunItem;
...
public class WaterGunRenderer {
	...
	public static class CustomRender extends EntityRenderer<WaterGunItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("ccalumod:textures/water.png");
		...
		public void render(WaterGunItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
			...
			EntityModel model = new ModelWater();
	...
	public static class ModelWater extends EntityModel<Entity> {
		...
		public ModelWater() {
			...
			bb_main.setTextureOffset(0, 0).addBox(-1.0F, -9.0F, -8.0F, 2.0F, 2.0F, 16.0F, 0.0F, false);
		}
