...
public class RazzalieousFenceBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:razzalieous_fence")
	public static final Block block = null;
	public RazzalieousFenceBlock(CcalumodModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("razzalieous_fence");
		}
