...
public class TimOLeavesBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_leaves")
	public static final Block block = null;
	public TimOLeavesBlock(CcalumodModElements instance) {
		super(instance, 162);
	}
