...
public class RazzantheumOreBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:razzantheum_ore")
	public static final Block block = null;
	public RazzantheumOreBlock(CcalumodModElements instance) {
		super(instance, 42);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("razzantheum_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ccalumod:razzantheum_ore_match"), () -> CustomRuleTest.codec);
