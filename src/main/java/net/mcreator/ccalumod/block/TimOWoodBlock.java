...
public class TimOWoodBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_wood")
	public static final Block block = null;
	public TimOWoodBlock(CcalumodModElements instance) {
		super(instance, 159);
	}
