...
public class RubyOreBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(CcalumodModElements instance) {
		super(instance, 18);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ccalumod:ruby_ore_match"), () -> CustomRuleTest.codec);
