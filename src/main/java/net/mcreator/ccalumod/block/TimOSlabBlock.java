...
public class TimOSlabBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_slab")
	public static final Block block = null;
	public TimOSlabBlock(CcalumodModElements instance) {
		super(instance, 164);
	}
