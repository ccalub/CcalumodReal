...
public class TimOFenceBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_fence")
	public static final Block block = null;
	public TimOFenceBlock(CcalumodModElements instance) {
		super(instance, 165);
	}
