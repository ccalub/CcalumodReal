...
public class TimOStairsBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_stairs")
	public static final Block block = null;
	public TimOStairsBlock(CcalumodModElements instance) {
		super(instance, 163);
	}
