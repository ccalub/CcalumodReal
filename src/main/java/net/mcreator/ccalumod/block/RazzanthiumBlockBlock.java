...
public class RazzanthiumBlockBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:razzanthium_block")
	public static final Block block = null;
	public RazzanthiumBlockBlock(CcalumodModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("razzanthium_block");
		}
