...
public class EmberFenceBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:ember_fence")
	public static final Block block = null;
	public EmberFenceBlock(CcalumodModElements instance) {
		super(instance, 119);
	}
