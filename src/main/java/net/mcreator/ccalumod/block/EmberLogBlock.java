...
public class EmberLogBlock extends CcalumodModElements.ModElement {

	@ObjectHolder("ccalumod:ember_log")
	public static final Block block = null;

	public EmberLogBlock(CcalumodModElements instance) {
		super(instance, 114);
