...
public class RazzalieousWoodBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:razzalieous_wood")
	public static final Block block = null;
	public RazzalieousWoodBlock(CcalumodModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("razzalieous_wood");
		}
