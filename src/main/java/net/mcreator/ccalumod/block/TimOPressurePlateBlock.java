...
public class TimOPressurePlateBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_pressure_plate")
	public static final Block block = null;
	public TimOPressurePlateBlock(CcalumodModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("tim_o_pressure_plate");
		}
