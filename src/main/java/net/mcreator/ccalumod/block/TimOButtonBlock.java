...
public class TimOButtonBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_button")
	public static final Block block = null;
	public TimOButtonBlock(CcalumodModElements instance) {
		super(instance, 168);
	}
