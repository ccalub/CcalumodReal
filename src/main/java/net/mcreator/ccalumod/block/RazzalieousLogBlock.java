...
public class RazzalieousLogBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:razzalieous_log")
	public static final Block block = null;
	public RazzalieousLogBlock(CcalumodModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("razzalieous_log");
		}
