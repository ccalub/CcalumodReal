...
public class RazzalieousPlanksBlock extends CcalumodModElements.ModElement {

	@ObjectHolder("ccalumod:razzalieous_planks")
	public static final Block block = null;

	public RazzalieousPlanksBlock(CcalumodModElements instance) {
		super(instance, 50);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("razzalieous_planks");
		}
