...
public class TimOPlanksBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_planks")
	public static final Block block = null;
	public TimOPlanksBlock(CcalumodModElements instance) {
		super(instance, 161);
	}
