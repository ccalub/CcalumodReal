...
public class TimOLogBlock extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:tim_o_log")
	public static final Block block = null;
	public TimOLogBlock(CcalumodModElements instance) {
		super(instance, 160);
	}
