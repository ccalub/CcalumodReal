...
public class EmberWoodBlock extends CcalumodModElements.ModElement {

	@ObjectHolder("ccalumod:ember_wood")
	public static final Block block = null;

	public EmberWoodBlock(CcalumodModElements instance) {
		super(instance, 113);
