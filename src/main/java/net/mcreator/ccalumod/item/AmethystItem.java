...
public class AmethystItem extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:amethyst")
	public static final Item block = null;
	public AmethystItem(CcalumodModElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A pearl of pure amethyst!"));
		}
	}
}
