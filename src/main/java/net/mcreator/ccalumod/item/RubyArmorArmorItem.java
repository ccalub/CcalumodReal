...
public class RubyArmorArmorItem extends CcalumodModElements.ModElement {
	@ObjectHolder("ccalumod:ruby_armor_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("ccalumod:ruby_armor_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("ccalumod:ruby_armor_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("ccalumod:ruby_armor_armor_boots")
	public static final Item boots = null;
	public RubyArmorArmorItem(CcalumodModElements instance) {
		super(instance, 137);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "ccalumod:textures/models/armor/rubyarmor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
